...
.config ($mdIconProvider) ->
  ...
  $mdIconProvider.icon 'device:external-bomi', 'images/icons/devices/external-bomi-icon.svg'
  $mdIconProvider.icon 'device:external-fleex', 'images/icons/devices/external-fleex-player-icon.svg'
  $mdIconProvider.icon 'device:external', 'images/icons/devices/external-icon.svg'
  $mdIconProvider.icon 'device:external-mpc-hc', 'images/icons/devices/external-mpc-hc-icon.svg'
  $mdIconProvider.icon 'device:external-mplayer', 'images/icons/devices/external-mplayer-icon.svg'
  $mdIconProvider.icon 'device:external-mpv', 'images/icons/devices/external-mpv-icon.svg'
  $mdIconProvider.icon 'device:external-smplayer', 'images/icons/devices/external-smplayer-icon.svg'
  $mdIconProvider.icon 'device:external-vlc', 'images/icons/devices/external-vlc-icon.svg'
